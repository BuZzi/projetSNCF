...
namespace LPDW\FoursquareBundle\Model;
...
class FoursquareApi {
	 ...
	 */
	public function  __construct($client_id = false,$client_secret = false, $redirect_uri='', $version='v2', $language='fr'){
	...
	public function getResponseFromJsonString($json) {
		...
		if ( !isset( $json->response ) ) {
			return new Reponse( 'Invalid response' );
		}
